...
namespace miCarBox
{
    ...
    inline b2Body* Create_Circle(b2World& physics_world, b2BodyType body_type, float x, float y, float radius)
        {
            // Se crea el body:
    ...
    inline b2Body* Create_Box(b2World& physics_world, b2BodyType body_type, float x, float y, float width, float height)
        {
            // Se crea el body:
    ...
    inline b2Body* Create_Edge(b2World& physics_world, b2BodyType body_type, float x0, float y0, float x1, float y1)
        {
            // Se crea el body:
    ...
    inline b2RevoluteJoint* Create_Revolute_Joint(b2World& physics_world, b2Body* body_a, b2Body* body_b, bool enable_motor = false)
        {
    ...
    inline   b2RevoluteJoint* Create_rev_joint(b2World& physics_world, b2Body* body_a, b2Body* body_b, float anchorAx, float anchorAy, bool enable_motor = false)
        {
            b2RevoluteJointDef joint_def;
    ...
    inline   b2Body* create_VshapePolygon(b2World& physics_world, b2BodyType body_type, float x, float y)
        {
            // Se crea el body:
    ...
    inline  bool process(Window& window, Input_Status& status, b2Body* body_a, b2Body* body_b, float window_height, float scale)
        {
            Event event;
    ...
    inline  b2Body* CreateRotatedBox(b2World& physics_world, b2BodyType bodytype, float xStart, float yStart, float xEnd, float yEnd, float angle)
        {
